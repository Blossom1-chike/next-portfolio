...
const QuoteSection = () => {
  return (
    <div className="flex flex-col relative overflow-hidden justify-between items-center w-full h-full max-w-[1350px] text-white mx-auto lg:px-24 px-10 md:px-16 xl:px-0 py-3">
        <Image className="absolute md:right-0 -right-9 w-[50px] top-10" src={Rectangle1} alt="" />
      <div>
